...
INSERT INTO fish_species (name, average_length_cm, points) VALUES
  ('Largemouth Bass',        50, 75),
  ('Smallmouth Bass',        45, 85),
  ('Spotted Bass',           40, 50),
  ('Northern Pike',          80, 50),
  ('Muskellunge (Muskie)',  110, 150),
  ('Walleye',                55, 90),
  ('Rainbow Trout',          50, 25),
  ('Brown Trout',            50, 25),
  ('Brook Trout',            35, 25),
  ('Lake Trout',             65, 30),
  ('Bluegill',               20, 20),
  ('Pumpkinseed Sunfish',    20, 20),
  ('Crappie (Black)',        30, 20),
  ('Crappie (White)',        30, 20),
  ('Channel Catfish',        55, 25),
  ('Blue Catfish',           60, 25),
  ('Flathead Catfish',       70, 25),
  ('Yellow Perch',           25, 25),
  ('Common Carp',            60, 20),
  ('Striped Bass',           60, 50),
  ('Bullhead',               30, 15)
